...
export interface Phase {
  ...
  type: PhaseType
  name: string
  technicianIds: string[] // Alterado de technicianId (string) para array de IDs
    ...
    phases: [
      {
        ...
        technicianIds: ["695a6403-7af7-4bd0-acd7-6c95ff2aca4f"],
        plannedStartDate: "2025-09-25",
    ...
    phases: [
      {
        ...
        type: "Requisitos",
        name: "Levantamento de requisitos",
        technicianIds: ["ac3c395a-41c9-488d-a609-48af95b8d854"],
        plannedStartDate: "2026-02-16",
...
export const tasks: Task[] = [
  ...
  // ROBOT tasks
  {
    ...
    ticket: "ac3c395a-41c9-488d-a609-48af95b8d854",
    technicianId: "ac3c395a-41c9-488d-a609-48af95b8d854",
